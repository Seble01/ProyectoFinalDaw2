...
<div id="botones-opciones" class="text-center">
  <button type="button" class="btn btn-primary" data-form-id="opcion-coche">Borrar coche</button>
  <br>
  <button type="button" class="btn btn-primary" data-form-id="opcion-moto">Borrar moto</button>
  <br>
